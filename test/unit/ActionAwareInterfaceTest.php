...
use Dhii\Action\ActionAwareInterface as TestSubject;
use Xpmock\TestCase;
 ...
 * @since [*next-version*]
 */
class ActionAwareInterfaceTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Action\ActionAwareInterface';
