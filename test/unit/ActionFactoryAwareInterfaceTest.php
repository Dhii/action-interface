...
use Dhii\Action\ActionFactoryAwareInterface as TestSubject;
use Xpmock\TestCase;
 ...
 * @since [*next-version*]
 */
class ActionFactoryAwareInterfaceTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Action\ActionFactoryAwareInterface';
