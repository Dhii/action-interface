...
use Dhii\Action\ActionFactoryInterface as TestSubject;
use Xpmock\TestCase;
 ...
 * @since [*next-version*]
 */
class ActionFactoryInterfaceTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Action\ActionFactoryInterface';
