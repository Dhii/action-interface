...
use Dhii\Action\Exception\ActionExceptionInterface as TestSubject;
use Xpmock\TestCase;
 ...
 * @since [*next-version*]
 */
class ActionExceptionInterfaceTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Action\Exception\ActionExceptionInterface';
