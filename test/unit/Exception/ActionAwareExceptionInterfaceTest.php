...
use Dhii\Action\Exception\ActionAwareExceptionInterface as TestSubject;
use Xpmock\TestCase;
 ...
 * @since [*next-version*]
 */
class ActionAwareExceptionInterfaceTest extends TestCase
{
    /**
     ...
     * @since [*next-version*]
     */
    const TEST_SUBJECT_CLASSNAME = 'Dhii\Action\Exception\ActionAwareExceptionInterface';
